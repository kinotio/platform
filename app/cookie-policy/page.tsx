        ...
        <div className='max-w-2xl px-8 py-4  rounded-lg shadow-md bg-gray-100 mt-8'>
          <div className='mt-2'>
            ...
            <p className='mt-2 text-black'>
              ...
              temporary and are deleted from your device when you close your web browser. Persistent
              cookies remain on your device for a specified period or until you delete them
              manually.
            </p>
          </div>
        </div>
        ...
        <div className='max-w-2xl px-8 py-4  rounded-lg shadow-md bg-gray-100 mt-8'>
          <div className='mt-2'>
            ...
            <p className='mt-2 text-black'>
              ...
              already on your computer, and you can set your browser to prevent them from being
              placed. If you do this, however, you may have to manually adjust some preferences
              every time you visit our website, and some features may not work correctly.
            </p>
          </div>
        </div>
