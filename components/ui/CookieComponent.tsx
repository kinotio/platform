      ...
      <div className='max-w-5xl px-4 py-8 mx-auto md:flex md:items-center md:gap-x-6'>
        <div className='flex items-start md:items-center gap-x-2'>
          <p className='text-white'>
            ...
            agree to{' '}
            <a href='/cookie' className='underline transition-colors duration-200 hover:text-black'>
              our use of cookies
            </a>
            .
          </p>
        </div>
        <button className='items-center justify-center hidden text-white transition-colors duration-300 rounded-full md:flex w-7 h-7 focus:outline-none'>
