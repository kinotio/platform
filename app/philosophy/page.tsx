          ...
          <div className='grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3'>
            ...
            <div className='space-y-3'>
              ...
              <p className='text-black pb-2'>
                ...
                tutorials, workshops, and mentorship programs, helping each other grow
            ...
            <div className='space-y-3'>
              ...
              <p className='text-black pb-2'>
                We celebrate diversity as a source of strength and creativity. We foster an
                inclusive environment where every voice is heard and valued. Our commitment to
                diversity is reflected in our teams, our partnerships, and the way we serve our
                global community.
              </p>
            </div>
            ...
            <div className='space-y-3'>
              ...
              <p className='text-black pb-2'>
                From open source software development to collaborative bug bashes, we actively
                engage in projects that challenge us, spark creativity, and drive meaningful impact.
              </p>
            </div>
