const NewsLetterFormComponent = () => {
  return (
    <div className='flex flex-col mt-8 space-y-3 sm:space-y-0 sm:flex-row sm:justify-center sm:-mx-2'>
      ...
      <button className='px-4 py-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-sm sm:mx-2 hover:bg-blue-600 focus:outline-none focus:bg-blue-600'>
        Get Started
      </button>
    </div>
  )
